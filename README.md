...
## ABSTRACT
### INPUT1: `kubecsv` (download)
*a bash script in this github repo. Instractions on downloading and using the script are in section "HOW TO" below*

### INPUT2: `.env` (autogenerated)
...
### INPUT2: `deploy.csv` (autogenerated)
